...
public class EventSink : IDisposable
{
	...
	{
		LogEvent((int)LogLevel.Information, message, detail);
	}
	...
	{
		LogEvent((int)LogLevel.Warning, message, detail);
	}

	public void Error(string message, string detail = null)
	{
		LogEvent((int)LogLevel.Error, message, detail);
	}

	public void Fatal(string message, string detail = null)
	{
		LogEvent((int)LogLevel.Critical, message, detail);
	}
