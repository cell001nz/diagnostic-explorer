...
public static class DiagnosticManager
{
	...
	public static async Task<OperationResponse> ExecuteOperation(IEnumerable<RegisteredObject> registeredObjects, string path, string operation, string[] arguments)
	{
		if (path == null)
