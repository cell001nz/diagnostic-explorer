...
public interface IDiagnosticHubClient
{
    ...
    Task<OperationResponse> SetPropertyWithContext(string requestId, SetPropertyRequest request);
...
{
    public static RpcResult Success(string requestId = null) => new() { RequestId = requestId, IsSuccess = true };
