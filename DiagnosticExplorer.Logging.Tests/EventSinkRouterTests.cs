...
public class EventSinkRouterTests
{
    ...
    public void AllMatchesFansOutToNamespaceAndSeverityDestinations()
    {
        ...
        int writes = router.Route(
            new EventSinkLogEvent("Widgets.Rendering", LogLevel.Warning, "Paint failed")
        );
    ...
    public void MostSpecificSelectsTheLongestNamespacePrefix()
    {
        ...
        EventSinkRouter router = new(
            new EventSinkRouteOptions
            {
                ...
                Routes =
                {
                    CreateRoute("Widgets", "Widgets"),
                    CreateRoute("Widgets.Rendering", "Rendering"),
                },
            },
            repo
        );
        ...
        router.Route(
            new EventSinkLogEvent("Widgets.Rendering.Canvas", LogLevel.Information, "Rendered")
        );
    ...
    public void DuplicateDestinationsAreWrittenOnce()
    {
        ...
        EventSinkRouter router = new(
            new EventSinkRouteOptions
            {
                Routes = { CreateRoute("Widgets", "Shared"), CreateRoute("*", "Shared") },
            },
            repo
        );

        int writes = router.Route(
            new EventSinkLogEvent("Widgets", LogLevel.Information, "Created")
        );
