...
public class TypeUtilTests
{
    ...
    [InlineData(typeof(List<int?>), "List<int?>")]
    public void GetFriendlyTypeName_ForVariousTypes_RendersExpectedName(Type type, string expected)
    {
    ...
    public void IsNullable_ForVariousTypes_ReturnsExpected(Type type, bool expected)
    {
